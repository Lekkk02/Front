...
const RecuperarContrasena = () => {
    ...
    const alSubmit = async (ev) => {
        ...
        if (result){
            ...
            emailjs.sendForm('service_4xwxc6u', 'template_qnece24', ev.target, 'hQiGy33WLjt9KtwHm')
    ...
    return(
        <div style={
            {backgroundImage: "linear-gradient(rgb(37, 3, 3), rgb(231, 24, 24))"}}  className="container-fluid overflow-hidden">
            <NavFuckingbar />
            <div className="row my-3">
                <div style={{boxShadow: "4px 4px 26px -2px rgba(0,0,0,0.68)"}} className="col-md-8 mx-auto bg-light p-4">
                    ...
                    <form onSubmit={alSubmit}>
                        ...
                        <button className="btn btn-primary btn-info btn-block text-center mx-auto"  type="submit">
                            Enviar Correo
                        </button>
                    </form>
                </div>
