  ...
  return (
    <div className="container-fluid">
      ...
      <div className="container mt-2">
        <label for="userid">Id del usuario a bannear</label> <br />
        <input
          id="userid"
          name="userid"
          value={idUser}
        ...
        <div className="d-flex row-flex aling-items-center mt-4">
          ...
          <div className="d-flex flex-column p-2">
            ...
            <div id="cargarTitulo" className="my-1">
              {username}
            </div>

            <p className="mt-2">Correo del usuario:</p>
            <div id="cargarCategoria1" className="my-1">
              {correo}
            </div>

            <p className="mt-2">Contribuciones realizadas:</p>
            <div id="cargarContribuciones" className="my-1">
              {strikes}
            </div>
          </div>
        </div>
