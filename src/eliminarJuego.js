...
const EliminarJuego = () => {
    ...
    function BuscarJuego(){
        ...
        const { data } = await axios.get(`/api/games/${idJuego}`);
    ...
    return(
      <div className="container-fluid">
        ...
        <div className="container mt-2">
            ...
            />
            <button className="btn btn-primary mx-3" onClick={BuscarJuego}>Buscar Juego</button>
            ...
            <div className="d-flex row-flex aling-items-center mt-4">
                <div className="d-flex p-2">
                    <img className="img-thumbnail" id="Imagen-juego" alt="..." src={images.gp2} />
                </div>

                <div className="d-flex flex-column p-2">
                    <p className="mt-2">Titulo del juego:</p>
                    <div id='cargarTitulo' className="mb-1">{nombre}</div>
            ...
            <div className="d-flex row-flex my-3">
                <button className="btn btn-block btn-primary btn-info" onClick={BorrarJuego}>BORRAR DE LA BASE DE DATOS</button>
            </div>
        </div>
      </div>  
    );
