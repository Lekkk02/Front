...
function SansionarUsuario(){
    ...
    function StrikeUser(){
        axios.get(`/api/users/strikes/${idUser}`).then(res => alert('Strike añadido', res)).catch(err => alert('Hubo un error', err))
    }
      ...
      <div className="container-fluid">
        ...
        <div className="container mt-2">
            ...
            <div className="d-flex row-flex my-3">
                <button className="btn btn-block btn-primary btn-info">SANSIONAR USUARIO DE LA PLATAFORMA</button>
            </div>
        </div>
      </div>  
    );
